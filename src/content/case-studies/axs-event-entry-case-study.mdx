...
Leadership believed fans would intuitively understand these different uses. As a band-aid fix for confusion, they had implemented an aggressive solution: automatically displaying the Mobile ID every time the app opened, regardless of whether fans had tickets.
...
The biggest challenge wasn't the design, it was aligning around a new way of thinking. The team had long believed that fans would intuitively understand the “Mobile ID,” but our research revealed a different story: they needed more context, not fewer steps.
