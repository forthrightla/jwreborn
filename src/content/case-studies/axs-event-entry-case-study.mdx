...
I led UX discovery and product strategy, collaborating closely with visual designers to ensure alignment and consistency, and stepped into a product leadership role when we didn't have a dedicated PM. With limited resources, I drove lean qualitative and quantitative research alongside UX peers to uncover insights that informed our design decisions and product priorities. Throughout the process, I partnered closely with engineers, ensuring the final product matched our vision down to functionality, visual details, and animations.
