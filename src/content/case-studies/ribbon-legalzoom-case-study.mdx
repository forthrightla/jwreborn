...
![The IA takes shape](/images/case-studies/ribbon-ia.png)
...
![Thread, our design system, is born](/images/case-studies/ribbon-thread.png)

### Week 3: Brand identity emerges
...
![A welcoming home page](/images/case-studies/ribbon-landing.png)
...
Between weeks, we analyzed drop-off points and optimized the flow. Using post-it notes and rapid prototyping, we identified friction points and tested solutions. The entire team collaborated in real-time to implement improvements.

![Iterating and A/B testing the funnel](/images/case-studies/ribbon-postits.png)
...
![Assets begin shipping](/images/case-studies/ribbon-assets.png)
...
![Sprinting to the finish line](/images/case-studies/ribbon-slack.png)
