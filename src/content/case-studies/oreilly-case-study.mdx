---
title: "Reducing support calls by 95% through a rapid redesign"
seoDescription: "Enterprise UX case study on reducing O’Reilly Auto Parts benefits enrollment support calls by 95% through rapid redesign and usability testing."
subtitle: "An enterprise UX case study showing how a rapid redesign reduced support calls by 95%."
client: "O'Reilly Auto Parts"
thumbnail: "/images/block-orly.png"
banner: "/images/case-studies/banner-orly.png"
tags: ["Enterprise UX"]
featured: false
highlight: "95% reduction in support calls, eliminating need for temporary staff"
goal: "Reduce friction in benefits enrollment process"
responsibilities: "UX design, Customer research, Usability testing"
duration: "2 months"
accentColor: "#2EC7A2"
heroWashColor: "68, 57, 98"
---
...
![Two annotated screenshots of the original benefits enrollment page with red markup highlighting confusing navigation, unclear form labels, and buried calls to action in the Required and Optional Forms sections](/images/case-studies/orly-original.png)
...
![Whiteboard with post-it notes comparing old and new enrollment flows: the old process with seven steps including a confusing overview page, and the streamlined new process that consolidates steps, with pink annotations questioning which screens are needed](/images/case-studies/orly-taskflow.png)

### Key design decisions

Through sketches and low-fidelity prototypes, I explored ways to simplify the experience. The solution consolidated multiple tasks into single steps and created a visual hierarchy that naturally guided users through the flow.

But the biggest win was the simplest change: I renamed "Overview" to "Action Required."

"Overview" was passive. It told users what existed, not what to do. Employees would land on the page, see a bunch of options, and immediately call support asking where to start. "Action Required" answered that question before they could ask it. Start here. Do this.

![Design evolution in three stages: a hand-drawn sketch of the to-do list concept with Action Required, Optional, and Complete sections, a wireframe refining the categorized benefits layout, and the final implemented interface](/images/case-studies/orly-evolution.png)
...
![The redesigned benefits enrollment interface with a left sidebar organizing forms into color-coded Action Required, Optional, and Completed sections, and a Beneficiaries form with primary and contingent beneficiary tables](/images/case-studies/orly-final.png)
...
The week of launch, I stopped by the Benefits department to check on the rollout. It was usually their most chaotic week of the year. Instead, the phones were quiet. 

Support calls dropped by 95%. The phone system didn't crash. No temporary staff were needed. The company saved tens of thousands in operational costs from one project.

We didn't rebuild the entire system. We fixed the front door.

The project became an internal case study for UX ROI, which led to increased investment in design. A few months later, my title was changed from Software Engineer to UX Designer -- the first at the company. I went on to be a UX team of one for around 100 internal web apps.
