...
<ProjectDetails 
goal="Audit product experience, develop customer journey map, guide 2 year product roadmap"
...
Cerebral is a $4.8B mental health startup focused on accessible, affordable therapy and medication. I was brought on as a consultant to lead a comprehensive research initiative to inform the 2021–2022 product roadmap. 

Key contributions include auditing the end-to-end product experience, creating a detailed customer journey map, and delivering actionable insights and roadmap recommendations.

The success of this project resulted in a **26% increase in customer satisfaction** and the hiring of a Director of Research and a four person research team.
...
<EnhancedOutcomeGrid 
  outcomes={[
    ...
    {
      description: "Based on project success, Cerebral hired a Director of Research and a team of four researchers",
      variant: "text-only",
      colorClass: "primary"
    }
  ]}
