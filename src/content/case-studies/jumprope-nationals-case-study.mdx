...
featured: false
outcomes: [
  "Uncovered how manual scoring processes created bottlenecks and errors",
  "Designed mobile judging solution that would eliminate runner system entirely",
  "Secured board buy-in to advance digital transformation efforts"
]
---
