...
To manage all of this I built two dashboards. An admin dashboard for the catalog itself: title browser, data quality monitoring, and a human review queue for ambiguous matches.
...
I also built an analytics dashboard with real-time health monitoring, cohort retention, activation funnels, and over 120 tracked events. I needed good data to make good product decisions, and the post-launch pivot proved that.
...
I also approached members of the Austin VHS scene while field testing the app to see if they would be interested in joining  the bets. Several were incredibly enthusiastic, and I was able to do guerrilla testing on features I was prototyping with my actual target users.

Real people were using it, and with my analytics dashboard I was able to see what they were doing. This created a feedback loop of iteration where I would see user behavior in aggregate, hear direct feedback from my testers, and then ship incremental updates and features that I could then see them using.
